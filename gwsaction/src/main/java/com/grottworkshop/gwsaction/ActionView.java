...
import com.grottworkshop.gwsaction.action.Action;
import com.grottworkshop.gwsaction.action.BackAction;
import com.grottworkshop.gwsaction.action.CloseAction;
import com.grottworkshop.gwsaction.action.DrawerAction;
import com.grottworkshop.gwsaction.action.LineSegment;
import com.grottworkshop.gwsaction.action.PlusAction;
 ...
 * <pre>
 * {@code
 * <com.grottworkshop.gwsaction.ActionView
...
public class ActionView extends View {
     ...
     */
    public void setAction(final View ourView,final Action fromAction, final Action toAction, final int rotation, long delay) {
        setAction(fromAction, false, ROTATE_CLOCKWISE);
        postDelayed(new Runnable() {
            @Override
            public void run() {
                if (!ViewCompat.isAttachedToWindow(ourView)) {
                    return;
                }
