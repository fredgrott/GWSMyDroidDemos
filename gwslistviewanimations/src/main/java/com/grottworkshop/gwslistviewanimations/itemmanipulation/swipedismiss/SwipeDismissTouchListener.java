...
/**
 * A {@link SwipeTouchListener} that directly dismisses the items when swiped.
...
public class SwipeDismissTouchListener extends SwipeTouchListener {
     ...
     *
     * @param listViewWrapper The {@code ListViewWrapper} containing the ListView whose items should
     *                        be dismissable.
    ...
    /**
     * An {@link ValueAnimator.AnimatorUpdateListener} which applies height animation to given {@link android.view.View}.
     */
