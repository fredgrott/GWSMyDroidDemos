 ...
 */
package com.grottworkshop.gwslistviewanimations.itemmanipulation.animateaddition;
...
/**
 * An adapter for inserting rows into the {@link android.widget.ListView} with an animation.
 * The root {@link android.widget.BaseAdapter} should implement {@link Insertable},
 * otherwise an {@link IllegalArgumentException} is thrown. This class only works with an
 * instance of {@code ListView}!
 * <p/>
 * Usage:<br>
...
public class AnimateAdditionAdapter<T> extends BaseAdapterDecorator {
     ...
     *                    or be a {@link BaseAdapterDecorator} whose BaseAdapter implements the interface.
     */
    ...
    /**
     * Set the duration of the scrolldown animation <i>per item</i> for when items are inserted
