package com.grottworkshop.gwslistviewanimations.itemmanipulation;
...
import com.grottworkshop.gwslistviewanimations.BaseAdapterDecorator;
import com.grottworkshop.gwslistviewanimations.itemmanipulation.animateaddition.AnimateAdditionAdapter;
import com.grottworkshop.gwslistviewanimations.itemmanipulation.dragdrop.DragAndDropHandler;
import com.grottworkshop.gwslistviewanimations.itemmanipulation.dragdrop.DraggableManager;
import com.grottworkshop.gwslistviewanimations.itemmanipulation.dragdrop.DynamicListViewWrapper;
import com.grottworkshop.gwslistviewanimations.itemmanipulation.dragdrop.OnItemMovedListener;
import com.grottworkshop.gwslistviewanimations.itemmanipulation.swipedismiss.DismissableManager;
import com.grottworkshop.gwslistviewanimations.itemmanipulation.swipedismiss.OnDismissCallback;
import com.grottworkshop.gwslistviewanimations.itemmanipulation.swipedismiss.SwipeDismissTouchListener;
import com.grottworkshop.gwslistviewanimations.itemmanipulation.swipedismiss.SwipeTouchListener;
import com.grottworkshop.gwslistviewanimations.itemmanipulation.swipedismiss.undo.SwipeUndoAdapter;
import com.grottworkshop.gwslistviewanimations.itemmanipulation.swipedismiss.undo.SwipeUndoTouchListener;
import com.grottworkshop.gwslistviewanimations.itemmanipulation.swipedismiss.undo.UndoCallback;
import com.grottworkshop.gwslistviewanimations.util.Insertable;
import com.grottworkshop.gwslistviewanimations.util.Swappable;
...
public class DynamicListView extends ListView {
    ...
    /**
     * The {@link AnimateAdditionAdapter}
     ...
     *
     * @param undoCallback the {@link UndoCallback}
     *                     that is used.
     */
    ...
    /**
     * Enables swipe to dismiss with contextual undo for this {@code DynamicListView}.
     * This method requires that a {@link SwipeUndoAdapter} has been set.
     * It is allowed to have the {@code SwipeUndoAdapter} wrapped in a {@link BaseAdapterDecorator}.
     *
    ...
    /**
     * Disables any swipe to dismiss functionality set by either {@link #enableSwipeToDismiss(OnDismissCallback)},
     * {@link #enableSwipeUndo(UndoCallback)} or {@link #enableSimpleSwipeUndo()}.
     */
     ...
     * and should implement {@link Swappable}.
     *
     ...
     *                                            and the adapter does not implement {@link Swappable}.
     */
    @Override
    ...
    /**
     * Sends a cancel event to given {@link TouchEventHandler}.
     *
     ...
     *
     * @throws java.lang.IllegalStateException if the adapter that was set does not implement {@link Insertable}.
     */
    ...
    /**
     * Sets the {@link DraggableManager} to be used
    ...
    /**
     * Sets the {@link OnItemMovedListener}
     ...
     * @param position the position of the item in the {@link android.widget.ListAdapter}. Must be visible.
     *
     * @throws java.lang.IllegalStateException if the {@link SwipeTouchListener}
     *                                         that is enabled does not extend {@link SwipeDismissTouchListener}.
     */
     ...
     *
     * @throws java.lang.IllegalStateException if the {@link SwipeTouchListener}
     *                                         that is enabled doe snot extend {@link SwipeUndoTouchListener}.
     */
