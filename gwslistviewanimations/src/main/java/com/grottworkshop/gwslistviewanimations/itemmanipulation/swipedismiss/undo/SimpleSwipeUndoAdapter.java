 ...
 */
package com.grottworkshop.gwslistviewanimations.itemmanipulation.swipedismiss.undo;
...
/**
 * An implementation of {@link SwipeUndoAdapter} which puts the primary and undo
 * {@link android.view.View} in a {@link android.widget.FrameLayout},
...
public class SimpleSwipeUndoAdapter extends SwipeUndoAdapter implements UndoCallback {
    ...
    /**
     * The {@link OnDismissCallback} that is notified of dismissed items.
     */
    @NonNull
     ...
     * @param dismissCallback the {@link OnDismissCallback} that is notified of dismissed items.
     */
