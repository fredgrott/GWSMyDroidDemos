...
import com.grottworkshop.gwslistviewanimations.itemmanipulation.TouchEventHandler;
 ...
 * {@link Swappable} {@link ListAdapter}.
 * This class only works properly on API levels 14 and higher.
 * <p/>
 * Users of this class must call {@link #onTouchEvent(android.view.MotionEvent)}
 * and {@link #dispatchDraw(android.graphics.Canvas)} on the right moments.
...
public class DragAndDropHandler implements TouchEventHandler {
    ...
    /**
     * Creates a new {@code DragAndDropHandler} for given {@link DynamicListView}.
     *
     ...
     * in given {@link DragAndDropListViewWrapper}
     *
     ...
     * @throws java.lang.IllegalArgumentException if the adapter does not implement {@link Swappable}.
     */
    ...
    /**
     * Sets the {@link OnItemMovedListener} that is notified when user has dropped a dragging item.
     */
     ...
     * <p/>
     * Finds the position and {@code View} of the touch point and, if allowed by the {@link DraggableManager},
     ...
     *
     * @return the position of the item in the list, or {@link android.widget.AdapterView#INVALID_POSITION}
     * if the {@code View} corresponding to the id was not found.
     */
     ...
     * <p/>
     * Animates the hover drawable to its final position, and finalizes our drag properties when
     * the animation has finished.
     * Will also notify the {@link OnItemMovedListener} set if applicable.
     *
     * @return {@code true} if the event was handled, {@code false} otherwise.
     */
    ...
    /**
     * By default, nothing is draggable. User should set a {@link DraggableManager} manually,
