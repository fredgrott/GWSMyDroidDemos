 ...
 */
package com.grottworkshop.gwslistviewanimations.itemmanipulation.swipedismiss;
...
import com.grottworkshop.gwslistviewanimations.util.AdapterViewUtil;
 ...
 * Implementations of this class should implement {@link #afterViewFling(android.view.View, int)}
 * to specify what to do after an item has been swiped.
...
public abstract class SwipeTouchListener implements View.OnTouchListener, TouchEventHandler {
    ...
    /**
     * The resource id of the {@link android.view.View} that may steal touch events from their parents.
     * Useful for example when the {@link android.widget.AbsListView} is in a horizontal
     * scroll container, but not the whole {@code AbsListView} should
     * steal the touch events.
     */
    private int mTouchChildResId;

    /**
     * The {@link DismissableManager} which decides
    ...
    /**
     * An {@link Animator.AnimatorListener} that notifies when the fling animation has ended.
     */
    ...
    /**
     * An {@link AnimatorListenerAdapter} that performs the dismissal animation when the current
     * animation has ended.
     */
