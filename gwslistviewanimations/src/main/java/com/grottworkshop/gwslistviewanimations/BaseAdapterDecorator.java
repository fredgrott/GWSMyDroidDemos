 ...
 */
package com.grottworkshop.gwslistviewanimations;
...
import com.grottworkshop.gwslistviewanimations.util.AbsListViewWrapper;
import com.grottworkshop.gwslistviewanimations.util.Insertable;
import com.grottworkshop.gwslistviewanimations.util.ListViewWrapper;
import com.grottworkshop.gwslistviewanimations.util.ListViewWrapperSetter;
 ...
 * <p/>
 * Classes extending this class can override methods and provide extra functionality before or
...
public abstract class BaseAdapterDecorator extends BaseAdapter implements SectionIndexer, Swappable, Insertable, ListViewWrapperSetter {
    ...
    /**
     * The {@link ListViewWrapper} containing the ListView this {@code BaseAdapterDecorator} will be bound to.
     */
    @Nullable
    ...
    /**
     * Returns the {@link ListViewWrapper} containing the ListView this {@code BaseAdapterDecorator}
     * is bound to.
     */
    @Nullable
    ...
    /**
     * Alternative to #setAbsListView(android.widget.AbsListView)}. Sets the {@link ListViewWrapper}
     * which contains the ListView this adapter will be bound to. Call this method before setting
     * this adapter to the ListView. Also propagates to the decorated {@code BaseAdapter} if applicable.
     */
    @Override
