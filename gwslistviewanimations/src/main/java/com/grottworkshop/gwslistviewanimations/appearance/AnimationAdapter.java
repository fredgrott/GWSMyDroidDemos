 ...
 */
package com.grottworkshop.gwslistviewanimations.appearance;
...
import com.grottworkshop.gwslistviewanimations.util.AnimatorUtil;
import com.grottworkshop.gwslistviewanimations.util.ListViewWrapper;

/**
 * A {@link BaseAdapterDecorator} class which applies multiple {@link Animator}s at once to views
 * when they are first shown. The Animators applied include the animations specified
...
public abstract class AnimationAdapter extends BaseAdapterDecorator {
    ...
    /**
     * Returns the {@link ViewAnimator} responsible for animating the Views in this adapter.
     */
    @Nullable
