...
/**
 * A class which decides whether given Views should be animated based on their position:
 * each View should only be animated once.
...
public class ViewAnimator {
    ...
    /**
     * Creates a new ViewAnimator, using the given {@link ListViewWrapper}.
     *
