 ...
 *
 */
package com.grottworkshop.gwsutil.state;
...
public class InstanceStateManager<T> {
    ...
    public static <T> void restoreInstanceState(T obj, Bundle savedInstanceState) {
        ...
        new InstanceStateManager<>(obj).restoreState(savedInstanceState);
    }

    private T mObj;
    private final HashMap<String, Field> mFieldsMap = new HashMap<>();
    private final HashMap<String, Boolean> mIsGsonMap = new HashMap<>();
    ...
    private static void setBundleValue(Field f, Object obj, Bundle bundle, String key, boolean isGson)
        ...
        if (type.equals(Boolean.TYPE)) {
            ...
            if (type.equals(ArrayList.class) && genericTypes[0] instanceof Class &&
