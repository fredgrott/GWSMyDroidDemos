package com.grottworkshop.gwsfoldablelayout;
...
import com.grottworkshop.gwsfoldablelayout.shading.FoldShading;
...
public class FoldableItemLayout extends FrameLayout {
    ...
    protected void onDetachedFromWindow() {
        ...
        // Big thank to MichaÅ‚ Ä†wiek https://github.com/jitsuCM.
        if (mCacheBitmap != null) {
            mCacheBitmap.recycle();
    ...
    //TODO: do we need a view constructor here?
    /**
    ...
    //TODO: do we need view constructor here?
    /**
    ...
    private static class PartView extends View {
        ...
        //TODO: do we need the super call here?
