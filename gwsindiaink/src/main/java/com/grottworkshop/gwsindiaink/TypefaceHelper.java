...
/**
 * TypefaceHelper, this is an api level 15 and up TypefaceHelper
...
public final class TypefaceHelper {
    ...
    /**
     * the sHelper TypefaceHelper instance variable setup as a private static to
     * limit access.
     */
    private static TypefaceHelper sHelper;

    /**
     * the mApplication instance variable kept private to limit
     * access
     */
    private final Application mApplication;

    /**
     * the mCache TypefaceCache instance variable kept private.
     */
    private final TypefaceCache mCache;

    /**
     * We set the mCache instance to the actual TypefaceCache instance.
