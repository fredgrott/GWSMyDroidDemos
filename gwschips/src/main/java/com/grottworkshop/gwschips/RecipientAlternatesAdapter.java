...
public class RecipientAlternatesAdapter extends CursorAdapter {
    ...
    public static void getMatchingRecipients(Context context, BaseRecipientAdapter adapter,
        ...
        if (recipientEntries.size() < addresses.size()) {
            ...
            try {
                directoryCursor = context.getContentResolver().query(BaseRecipientAdapter.DirectoryListQuery.URI,
                        BaseRecipientAdapter.DirectoryListQuery.PROJECTION, null, null, null);
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        mDropdownChipLayouter.bindView(view, null, entry, position,
                DropdownChipLayouter.AdapterType.RECIPIENT_ALTERNATES, null);
    }
