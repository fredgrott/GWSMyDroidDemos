...
public final class Scene {
    ...
    static void setCurrentScene(View view, Scene scene) {
        view.setTag(com.grottworkshop.gwsscenetransitions.R.id.current_scene, scene);
    }
    ...
    static Scene getCurrentScene(View view) {
        return (Scene) view.getTag(com.grottworkshop.gwsscenetransitions.R.id.current_scene);
    }
