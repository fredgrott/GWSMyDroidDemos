            ...
            for (int k = 0; k < val.length; k += incr) {
                switch (cmd) {
                    ...
                    case 'V': // vertical lineto - Draws a vertical line from the current point
                        ...
                        currentY = val[k + 0];
                        break;
                    case 'c': // curveto - Draws a cubic B̩zier curve (relative)
                        ...
                        break;
                    case 'C': // curveto - Draws a cubic B̩zier curve
                        ...
                        ctrlPointY = val[k + 3];
                        break;
                    case 's': // smooth curveto - Draws a cubic B̩zier curve (reflective cp)
                        ...
                        currentY += val[k + 3];
                        break;
                    case 'S': // shorthand/smooth curveto Draws a cubic B̩zier curve(reflective cp)
                        ...
                        currentY = val[k + 3];
                        break;
                    case 'q': // Draws a quadratic B̩zier (relative)
                        ...
                        currentY += val[k + 3];
                        break;
                    case 'Q': // Draws a quadratic B̩zier
                        ...
                        currentY = val[k + 3];
                        break;
                    case 't': // Draws a quadratic B̩zier curve(reflective control point)(relative)
                        reflectiveCtrlPointX = 0;
                        reflectiveCtrlPointY = 0;
                        ...
                        currentY += val[k + 1];
                        break;
                    case 'T': // Draws a quadratic B̩zier curve (reflective control point)
                        reflectiveCtrlPointX = currentX;
                        reflectiveCtrlPointY = currentY;
                        if (previousCmd == 'q' || previousCmd == 't'
                                || previousCmd == 'Q' || previousCmd == 'T') {
