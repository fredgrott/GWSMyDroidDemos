...
import static com.grottworkshop.gwsmaterialmenu.MaterialMenuDrawable.DEFAULT_COLOR;
import static com.grottworkshop.gwsmaterialmenu.MaterialMenuDrawable.DEFAULT_VISIBLE;
...
public class MaterialMenuView extends View implements MaterialMenu {
    ...
    private static class SavedState extends BaseSavedState {
        ...
        private SavedState(Parcel in) {
            super(in);
            state = MaterialMenuDrawable.IconState.valueOf(in.readString());
