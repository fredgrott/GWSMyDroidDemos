...
import com.grottworkshop.gwsmaterialprogressbar.internal.ObjectAnimatorCompat;
...
class Animators {
    ...
    public static Animator createIndeterminate(Object target) {
        ...
        ObjectAnimator trimPathStartAnimator = ObjectAnimatorCompat.ofFloat(target, "trimPathStart", 0,
                0.75f);
        ...
        ObjectAnimator trimPathEndAnimator = ObjectAnimatorCompat.ofFloat(target, "trimPathEnd", 0,
                0.75f);
        ...
        ObjectAnimator trimPathOffsetAnimator = ObjectAnimatorCompat.ofFloat(target, "trimPathOffset", 0,
                0.25f);
